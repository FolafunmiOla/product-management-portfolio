    ...
    <main className="mx-auto max-w-5xl px-4 py-10 sm:px-8">
      <div className="space-y-12">
        ...
        <section className="text-center">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg leading-8 text-slate-600 dark:text-slate-300">
        ...
        <section className="grid gap-6 md:grid-cols-2">
          {/* Email Card */}
          <div className="group rounded-3xl border border-slate-200/70 bg-white/90 p-8 shadow-soft transition hover:shadow-lg dark:border-slate-800/70 dark:bg-slate-900/85">
            <div className="flex items-start gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-accent/10 text-accent transition group-hover:bg-accent group-hover:text-white">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="mt-3 inline-flex items-center gap-2 text-accent hover:text-accent/80 transition"
                >
                  oyewalebisola23@gmail.com
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="mt-3 inline-flex items-center gap-2 text-accent hover:text-accent/80 transition"
                >
                  linkedin.com/in/bisola-oyewale-540285217
                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                </a>
