...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-surface/90 backdrop-blur-xl dark:border-slate-800/70 dark:bg-[#1A1814]/95">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 text-sm text-slate-700 dark:text-slate-200">
        ...
        <nav className="flex items-center gap-6">
          ...
          <button
            ...
            className="rounded-full border border-slate-300/70 bg-white/90 px-3 py-1 text-slate-900 transition hover:border-slate-400 dark:border-slate-700 dark:bg-slate-900/90 dark:text-slate-100"
          >
